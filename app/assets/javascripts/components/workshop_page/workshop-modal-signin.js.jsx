        ...
        <section id="modal" className="modal is-active">
            <article className="modal-content">
              ...
              <div className="modal-signup">
                <span className="signin">Please sign in to register for {this.props.workshop.title}</span>
              </div>
              <button className="btn profile-btn" onClick={this.sendSignIn}>Sign in</button>
            </article>
