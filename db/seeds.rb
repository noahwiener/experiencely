...
photos = Photo.create([{name: 'Noah', imageable_type: "User", imageable_id: users[2-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/c_crop,h_203,w_200,x_0,y_0/v1445277732/noah_profile_bsiwvo.jpg"},
                      ...
                      {name: 'Rumo', imageable_type: "User", imageable_id: users[1-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791515/rumo_zmydc7.jpg"},
                      {name: '0_hike2', imageable_type: "Workshop", imageable_id: workshops[2-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791312/doghike_xjv4pg.jpg"},
                      {name: 'beach', imageable_type: "Workshop", imageable_id: workshops[2-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791770/beach_fspqao.jpg"},
                      {name: 'ears', imageable_type: "Workshop", imageable_id: workshops[2-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791301/ears_krs3wm.jpg"},
                      ...
                      {name: 'rumo', imageable_type: "Workshop", imageable_id: workshops[7-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791301/ears_krs3wm.jpg"},
                      ...
                      {name: 'bike', imageable_type: "Workshop", imageable_id: workshops[11-1].id, url: "https://res.cloudinary.com/drfyambuq/image/upload/v1446791308/bike_bfyanz.jpg"},
