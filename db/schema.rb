...
ActiveRecord::Schema.define(version: 20151020181008) do
  ...
  add_index "reviews", ["user_id", "workshop_id"], name: "index_reviews_on_user_id_and_workshop_id", unique: true, using: :btree
